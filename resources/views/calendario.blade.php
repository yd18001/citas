    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function mostrarCitas(fecha) {
                $.ajax({
                    url: '{{ route('citas.getPorFecha') }}', // ruta a tu controlador que obtiene las citas por fecha
                    type: 'GET',
                    data: {
                        fecha: fecha
                    },
                    success: function(data) {
                        // Renderiza las citas en la vista
                        // Por ejemplo, puedes mostrarlas en un modal
                        $('#modal-citas .modal-body').html(data);
